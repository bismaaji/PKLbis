...
public class konfigurasi {
    ...
    public static final String URL_ADD = "http://192.168.33.7/Pegawai/tambah.php";
    public static final String URL_GET_ALL = "http://192.168.33.7/Pegawai/tampil_semua.php";
    public static final String URL_GET_EMP = "http://192.168.33.7/Pegawai/tampil_detail.php?id=";
    public static final String URL_UPDATE_EMP = "http://192.168.33.7/Pegawai/update.php";
    public static final String URL_DELETE_EMP = "http://192.168.33.7/Pegawai/delete.php?id=";
